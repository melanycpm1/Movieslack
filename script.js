...
let tituloUno= document.querySelector(".titulo_uno");
let tituloDos=document.querySelector(".titulo_dos");
let tituloTres=document.querySelector(".titulo_tres");
let tituloCuatro=document.querySelector(".titulo_cuatro");

let parrafo_sound=document.querySelector(".parrafo_sound");
let parrafo_nun=document.querySelector(".parrafo_nun");
let parrafo_haunted=document.querySelector(".parrafo_haunted");
let parrafo_mission=document.querySelector(".parrafo_mission");

tituloUno.textContent=peliculas[1].title;
tituloDos.textContent=peliculas[0].title;
tituloTres.textContent=peliculas[4].title
tituloCuatro.textContent=peliculas[7].title;

parrafo_sound.textContent=peliculas[1].overview;
parrafo_nun.textContent=peliculas[0].overview;
parrafo_haunted.textContent=peliculas[4].overview;
parrafo_mission.textContent=peliculas[7].overview;